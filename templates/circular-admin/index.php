...
<?php echo $reg['scc_extracting_content']; ?>
				...
				<div class="colDiv imgRight">
					...
					<h4 id="countCasc1">
						<input class="number-s1" type="number" name="scc_extracting_nro_one" value="<?php echo $reg['scc_extracting_nro_one']; ?>">
					</h4>
					<h4 id="countCasc2">
						<input class="number-s1" type="number" name="scc_extracting_nro_two" value="<?php echo $reg['scc_extracting_nro_two']; ?>">
					</h4>
					<h4 id="countCasc3">
						<input class="number-s1" type="number" name="scc_extracting_nro_tree" value="<?php echo $reg['scc_extracting_nro_tree']; ?>">
					</h4>
				</div>
			</section>
				...
				<div class="flex contWorld">
					<div class="colDiv">
						...
						<div class="data-chart">
							...
							<input type="number" name="scc_worldwide_chart_one" value="<?php echo $reg['scc_worldwide_chart_one']; ?>"><br>
							<label>Non-recoverable (in %): </label>
							<input type="number" name="scc_worldwide_chart_two" value="<?php echo $reg['scc_worldwide_chart_two']; ?>"><br>
							<label>Recycled (in %): </label>
							<input type="number" name="scc_worldwide_chart_tree" value="<?php echo $reg['scc_worldwide_chart_tree']; ?>">
							
							<h2>Data Chart Recycled</h2>
							<label>Exported (in %):</label>
							<input type="number" name="scc_worldwide_chart_recycled_one" value="<?php echo $reg['scc_worldwide_chart_recycled_one']; ?>"><br>
							<label>Used in Europe (in %): </label>
							<input type="number" name="scc_worldwide_chart_recycled_two" value="<?php echo $reg['scc_worldwide_chart_recycled_two']; ?>">
...
<?php echo $reg['scc_fostering_content']; ?>
				...
				<div class="imgFostering">
					<h3 id="countFost1"><input type="number" name="scc_fostering_nbr_two" value="<?php echo $reg['scc_fostering_nbr_two']; ?>">%</h3>
					<h3 id="countFost2"><input type="number" name="scc_fostering_nbr_one" value="<?php echo $reg['scc_fostering_nbr_one']; ?>">%</h3>
					<h3 id="countFost3"><input type="number" name="scc_fostering_nbr_tree" value="<?php echo $reg['scc_fostering_nbr_tree']; ?>">%</h3>
			...
			<section class="latesData">
				...
				<div class="chart-container">
					<div class="grafica">
						...
						<input type="number" name="scc_latest_chart_european_one" value="<?php echo $reg['scc_latest_chart_european_one']; ?>"><br><br>
						<label>CEPI Countries (in %):</label>
						<input type="number" name="scc_latest_chart_european_two" value="<?php echo $reg['scc_latest_chart_european_two']; ?>"><br><br>
						<label>North America (in %):</label>
						<input type="number" name="scc_latest_chart_european_tree" value="<?php echo $reg['scc_latest_chart_european_tree']; ?>"><br><br>
						<label>Total World (in %):</label>
						<input type="number" name="scc_latest_chart_european_four" value="<?php echo $reg['scc_latest_chart_european_four']; ?>"><br><br>
						<label>Asia (in %):</label>
						<input type="number" name="scc_latest_chart_european_five" value="<?php echo $reg['scc_latest_chart_european_five']; ?>"><br><br>
						<label>Latin America (in %):</label>
						<input type="number" name="scc_latest_chart_european_six" value="<?php echo $reg['scc_latest_chart_european_six']; ?>"><br><br>
						<label>Africa (in %):</label>
						<input type="number" name="scc_latest_chart_european_seven" value="<?php echo $reg['scc_latest_chart_european_seven']; ?>"><br><br>
					</div>
				</div>
			</section>
